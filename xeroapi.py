...
class XeroApi:
    ...
    def dump_pay(self):
        try:
            reader = self.payments()
        except Exception as e:
            print(f'Error occured while retrieving data from api. Getting ata from file ..........')
            with open('./payments.json') as f:
                reader = json.load(f)

        BQcall(reader, "Payments")
